...
const handleShare = async () => {
  ...
  try {
    ...
    // Add export mode class so header/footer become visible
    reportRef.current.classList.add("pdf-export-mode");

    // Wait for ALL images in the report (logo + channel thumbnail + video thumbs) to fully load
    ...
    // Small extra delay to allow layout to settle after making header/footer visible
...
// JPEG at 75% quality → massive file size drop vs PNG
