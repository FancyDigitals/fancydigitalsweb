...
export default function ProjectEditorClient({ projectId }) {
  ...
  // Auto-slug from title (only if slug empty)
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <textarea
                  ...
                  placeholder="What was the client struggling with before working with you?"
                  rows={5}
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <textarea
                  ...
                  placeholder="What did you build and how did it solve the problem?"
                  rows={5}
                  className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm outline-none focus:border-[#075a01] focus:bg-white"
                />
              </div>
