...
export default function TodmaBrandIdentityCaseStudy() {
  const galleryImages = [
    { src: "/portfolio/todma/pattern.jpg", label: "Brand Pattern" },
    { src: "/portfolio/todma/multiple-variations.jpg", label: "Logo Variations" },
    { src: "/portfolio/todma/stacked-mockup.jpg", label: "Stationery Mockup" },
    { src: "/portfolio/todma/car-mockup.jpg", label: "Vehicle Branding" },
    { src: "/portfolio/todma/showroom.jpg", label: "Showroom Display" },
  ];

  const objectives = [
    { text: "Establish a clear and professional brand presence", icon: "🎯" },
    { text: "Create consistent visual rules across all touchpoints", icon: "📐" },
    { text: "Improve brand recognition and trust", icon: "🤝" },
    { text: "Design a system that scales with the business", icon: "📈" },
  ];
  ...
  const process = [
    {
      ...
      description: "Deep dive into TODMA's business, values, competitors, and target audience to inform strategic brand direction.",
    },
    {
      phase: "02",
      title: "Strategy & Concept",
      description: "Developed core brand positioning, personality traits, and visual concept directions for client review.",
    },
    {
      phase: "03",
      title: "Visual Design",
      description: "Created the logo, color system, typography, and supporting visual elements with meticulous attention to detail.",
    },
    {
      phase: "04",
      title: "System & Delivery",
      description: "Built comprehensive brand guidelines and delivered all assets in formats ready for immediate use.",
    },
  ];
    ...
    <main className="relative min-h-screen bg-gradient-to-b from-gray-950 via-[#0a0a0a] to-gray-950 text-white overflow-hidden">
          ...
          <div className="inline-flex items-center rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] px-5 py-3 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
            <ol className="flex flex-wrap items-center gap-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="font-semibold text-white">TODMA Brand Identity</span>
              </li>
            </ol>
          </div>
        </nav>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 leading-relaxed max-w-xl">
                ...
                consistency, and long-term brand recognition for lasting impact.
              </p>
            </div>
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-[23px] bg-gradient-to-br from-gray-900/95 to-gray-950/95 backdrop-blur-xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
                  ...
                  <div className="space-y-3">
                    {[
                      { label: "Category", value: "Graphics Design", color: "text-[#0a9001]" },
                      { label: "Focus", value: "Brand Identity", color: "text-[#ff914d]" },
                      { label: "Timeline", value: "4 Weeks", color: "text-white" },
                    ].map((item, index) => (
        ...
        <div className="group relative">
          ...
          >
            ...
            <div
              ...
              "
              style={{ backgroundImage: "url(/portfolio/todma/cover.jpg)" }}
            />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-white">TODMA</p>
                  </div>
                </div>
            ...
            <div className="relative p-8 rounded-3xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-sm">
              ...
              <div className="relative space-y-6 text-base md:text-lg leading-relaxed text-gray-300">
                <p>
                  ...
                  that feels <span className="text-white font-semibold">confident</span>, <span className="text-[#0a9001] font-semibold">structured</span>, and <span className="text-[#ff914d] font-semibold">timeless</span>. The goal was to
                ...
                <p>
                  ...
                  business grows into new markets and opportunities.
                </p>
              </div>
      ...
      <section className="relative mx-auto max-w-7xl px-5 pb-28 md:px-10 animate-[fadeUp_1s_ease-out_0.7s_both]">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-white">Brand Visuals</h2>
            <p className="text-sm text-gray-500">The complete visual system</p>
          </div>
        </div>
            ...
            >
              <div
                className={`
                  ...
                  ${index === 0 ? "h-[300px] lg:h-[280px]" : "h-[260px]"}
                `}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
              <div className="max-w-xl">
                ...
                <p className="text-base text-white/80 leading-relaxed">
                  ...
                  and designed for long-term growth and recognition.
                </p>
              </div>
