export const aboutPage = {
  ...
  experience: [
    { label: "Graphics Design", years: 9 },
    { label: "Blogging & Content", years: 9 },
    { label: "Web Development", years: 8 },
    { label: "SEO & Growth", years: 7 },
    { label: "Email Marketing", years: 7 },
  ],
  ...
  clientTypes: [
    ...
    "Brands refining digital presence",
    "Creators monetizing platforms",
    "Teams that value clarity",
  ],

  signature: {
    name: "Bashir Ismail (Fancy)",
    title: "Founder & Digital Architect",
  },
};